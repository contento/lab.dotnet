...
public partial class MainForm : Form
{
    ...
    {
        Text = $@"Asymmetric Encryption - Subject={SubjectName}";
        textBoxClearText.Text = $@"Hello World! v.{DateTime.Now:yyyy.MM.dd}";
    ...
    private byte[]? AsymmetricEncrypt(byte[] plainTextBytes)
    {
        ...
        return checkBoxBouncy.Checked ? BouncyAsymmetricEncrypt() : MicrosoftAsymmetricEncrypt();

        byte[]? BouncyAsymmetricEncrypt()
        {
        ...
        byte[]? MicrosoftAsymmetricEncrypt()
        {
    ...
    {
        return checkBoxBouncy.Checked ? BouncyAsymmetricDecrypt() : MicrosoftAsymmetricDecrypt();

        byte[]? BouncyAsymmetricDecrypt()
        {
        ...
        byte[]? MicrosoftAsymmetricDecrypt()
        {
    ...
    public byte[] SymmetricEncrypt(string plainText, byte[] key)
    {
        ...
        return checkBoxBouncy.Checked ? BouncySymmetricEncrypt() : MicrosoftSymmetricEncrypt();

        byte[] BouncySymmetricEncrypt()
        {
        ...
        byte[] MicrosoftSymmetricEncrypt()
        {
    ...
    public string SymmetricDecrypt(byte[] cipherData, byte[] key)
    {
        ...
        return checkBoxBouncy.Checked ? BouncySymmetricDecrypt() : MicrosoftSymmetricDecrypt();

        string BouncySymmetricDecrypt()
        {
            var nonce = new byte[NonceSize];
        ...
        string MicrosoftSymmetricDecrypt()
        {
            using var aesGcm = new AesGcm(key);
